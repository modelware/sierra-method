...
stylesheet:
  ...
  - selector: node.objective
    style:
      ...
      height: 48
      icon:
        href: workspace:/src/md/images/objective.svg
  ...
  - selector: node.capability
    style:
      ...
      height: 48
      icon:
        href: workspace:/src/md/images/capability.svg
  ...
  - selector: node.actor
    style:
      ...
      height: 53
      icon:
        href: workspace:/src/md/images/actor.svg
  ...
  - selector: node.entity
    style:
      ...
      height: 64
      icon:
        href: workspace:/src/md/images/entity.svg
---
